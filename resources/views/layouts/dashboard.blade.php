...
<head>
    ...
    <title>Dashboard &mdash; Solar CRM</title>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('home') }}" class="brand-link">
                ...
                <span class="brand-text">Solar CRM</span>
            </a>
        ...
        <header class="top-header">
            <div class="header-left">
                ...
                <div class="search-bar">
                    ...
                    <input type="text" id="dashboardSearch" placeholder="Search everywhere..." class="search-input">
                </div>
            </div>
