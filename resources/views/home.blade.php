        ...
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <a href="#" class="btn-primary btn-large">
                    Get Started
                    <svg style="margin-left:8px; width:20px; height:20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                </a>
        ...
        <div class="hero-visual">
            ...
            <div class="visual-wrapper">
                <div class="visual-inner">
                    <img src="https://images.unsplash.com/photo-1581093458791-9f3c3900df4b?q=80&w=1200&auto=format&fit=crop" alt="Solar Panels Management Dashboard" class="visual-img">
